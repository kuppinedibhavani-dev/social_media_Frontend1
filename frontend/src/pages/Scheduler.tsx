...
const Scheduler = () => {
 ...
 const createPost = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const { scheduled, message } = res.data;
  ...
  return (
    <PageWrapper>
      <h1 className="text-3xl font-bold dark:text-white mb-6">Scheduler</h1>

      {/* ------------------------------ FORM ------------------------------ */}
      <form onSubmit={createPost} className="glass-card p-6 rounded-xl space-y-4">
